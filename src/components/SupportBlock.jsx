...
const SupportBlock = () => {
    return (
        <div className="support-block col-container">
            <div className="support-header row-container">
                <div className="support-img">
                    <img src="/assets/images/plane-icon.png" alt="Самолетик"/>
                </div>
                <span className="support-header__text">Связаться с поддержкой</span>
            </div>
            <textarea className="support-input" placeholder="Ваш вопрос"></textarea>
